...
import br.com.rperatello.bankcoreapi.services.ICustomerService;
...
public class CustomerController {	
	...
	@Operation(
		summary = "Get all customers", description = "Finds all customers in JSON, XML or YML representation",
		tags = {"Customer"},
		responses = {
	...
	@Operation(
		summary = "Finds a customer by ID", description = "Finds a customer in JSON, XML or YML representation",
		tags = {"Customer"},
		responses = {
			@ApiResponse(description = "Success", responseCode = "200",
	...
	@Operation(
		summary = "Finds a customer by document", description = "Finds a customer in JSON, XML or YML representation",
		tags = {"Customer"},
		responses = {
			@ApiResponse(description = "Success", responseCode = "200",
				content = @Content(schema = @Schema(implementation = CustomerResponseVO.class))
	...
	public CustomerResponseVO findByDocument(@PathVariable(value = "document") String document) {
		var res = customerService.findByDocument(document);
		return res;
	}
