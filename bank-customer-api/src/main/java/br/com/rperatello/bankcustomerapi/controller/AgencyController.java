...
import br.com.rperatello.bankcustomerapi.services.IAgencyService;
...
public class AgencyController {	
	...
	@Operation(
		summary = "Get all agencies", description = "Finds all agencies",
		tags = {"Agency"},
		responses = {
	...
	@Operation(
		summary = "Finds a agency", description = "Finds a agency",
		tags = {"Agency"},
		responses = {
			@ApiResponse(description = "Success", responseCode = "200",
